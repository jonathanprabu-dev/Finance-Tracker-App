...
export const metadata: Metadata = {
  title: "FinTrack — Personal Finance & Stock Tracker",
  description: "Track cash flow, debt, and investments in one Net Worth dashboard.",
};
    ...
    >
      <head>
        {/* Resolve theme before paint to avoid a flash of the wrong theme:
            use the stored choice if set, otherwise the OS preference. */}
        <script
